...
export function InfrastructureLegend() {
  ...
  return (
    <div className="absolute top-3 right-3 z-[1000] flex flex-col gap-1.5">
      <div className="px-2.5 py-2 rounded-lg bg-black/80 border border-[var(--palantir-border)] backdrop-blur-sm">
      ...
      <div className="px-2.5 py-2 rounded-lg bg-black/80 border border-[var(--palantir-border)] backdrop-blur-sm flex gap-4">
        <div>
